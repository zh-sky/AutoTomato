...
class FinanceHandle:
    ...
    def click_confirm_date_button(self):
        ...
        :return:
        """
        self.finance_page.get_confirm_date_element().click()
    ...
    def send_num_textfield(self, text):
        ...
        :return:
        """
        self.finance_page.get_num_element().send_keys(text)
    ...
    def send_price_textfield(self, text):
        ...
        :return:
        """
        self.finance_page.get_price_element().send_keys(text)
    ...
    def send_money_textfield(self, text):
        ...
        :return:
        """
        self.finance_page.get_money_element().send_keys(text)
    ...
    def click_good_sale(self):
        ...
        :return:
        """
        self.finance_page.get_sale_element().click()
    ...
    def click_cost_expend(self):
        ...
        :return:
        """
        self.finance_page.get_cost_element().click()
    ...
    def click_other_income(self):
        ...
        :return:
        """
        self.finance_page.get_other_element().click()
    ...
    def click_back_button(self):
        ...
        :return:
        """
        self.finance_page.get_back_button_element().clcik()
